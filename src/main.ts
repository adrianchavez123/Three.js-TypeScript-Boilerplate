...
const meshes = [
  new THREE.Mesh(geometry, new THREE.MeshBasicMaterial({ color: data.color })), //flatshading doesn't exist
  ...
  new THREE.Mesh(
    geometry,
    new THREE.MeshStandardMaterial({ color: data.color, flatShading: true }) //works with enviroment lights "HDRS"
  ),
];
